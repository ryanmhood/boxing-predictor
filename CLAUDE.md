...
**YOU ARE IN: `boxing_predictor/polecats/nux/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/boxing_predictor/` (rig root) or other directories
...
**Your mail address:** `boxing_predictor/polecats/nux`
**Your rig:** boxing_predictor
**Your Witness:** `boxing_predictor/witness`
...
| Ask Witness for help | `gt mail send boxing_predictor/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`boxing_predictor/witness`) when:
...
```bash
gt mail send boxing_predictor/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
